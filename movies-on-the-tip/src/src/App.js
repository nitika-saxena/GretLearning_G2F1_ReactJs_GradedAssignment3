    ...
    <Router>
      <div className="app">
        ...
        <div className="content">
          <Routes>
            <Route path="/" element={<MovieList category="movies-in-theaters" addToFavorites={addToFavorites} favoriteMovies={favoriteMovies} searchQuery={searchQuery} />} />
            <Route path="/coming-soon" element={<MovieList category="movies-coming" addToFavorites={addToFavorites} favoriteMovies={favoriteMovies} searchQuery={searchQuery} />} />
            <Route path="/top-rated-india" element={<MovieList category="top-rated-india" addToFavorites={addToFavorites} favoriteMovies={favoriteMovies} searchQuery={searchQuery} />} />
            <Route path="/top-rated-movies" element={<MovieList category="top-rated-movies" addToFavorites={addToFavorites} favoriteMovies={favoriteMovies} searchQuery={searchQuery} />} />
